def checkio(data):
    ...
    Концепция «Математически счастливых билетов» аналогична идее русских «Счастливых билетов». Это относится к старым билетам на общественный транспорт, на которых были напечатаны шестизначные числа.
